...
line_bot_api = LineBotApi('l16c/YmV9/oacziNyVODB+lhwA5sBoRVATkEi4JbJn/SMbk2CgJ03of/d3M5oBqD3630DYHZ0nODLmqIrCsujC3+VLTq4JxBA6pz49bWulLzu3iB4ZsBIsPtM0hure/Wu41U6C02YMN7GuVs+rlt2wdB04t89/1O/w1cDnyilFU=')
# 必須放上自己的Channel Secret
handler = WebhookHandler('f1d7dbd05d97ffdc586fcdffa9e7cad9')

line_bot_api.push_message('U7017b5f1282e2b417988216fb34e1d77', TextSendMessage(text='你可以開始了'))
